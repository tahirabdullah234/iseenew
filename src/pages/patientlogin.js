    ...
    <div className="container">
      ...
      <div className={classes.card}>
        <div className={classes.banner}>
          ...
          <Typography className={classes.bannerText}>Welcome Back</Typography>
          <Typography className={classes.bannerSub}>
            Login to manage your health records and appointments.
          </Typography>
        </div>
        <div className={classes.formPanel}>
          <Typography className={classes.formTitle}>Patient Login</Typography>
