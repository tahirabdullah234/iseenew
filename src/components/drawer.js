          ...
          <Grid container xs={12}>
            <List>
              <ListItem button key={1}>
                ...
                <ListItemText
                  primary={<Typography variant="p">USER PROFILE</Typography>}
                />
              </ListItem>
              ...
              <ListItem button key={3}>
                ...
                <ListItemText
                  primary={<Typography variant="p">REPORTS</Typography>}
                />
              </ListItem>
              ...
              <ListItem button key={6}>
                ...
                <ListItemText
                  primary={<Typography variant="p">APPOINT DOCTORS</Typography>}
                />
              </ListItem>
              <ListItem button key={7}>
                ...
                <ListItemText
                  primary={<Typography variant="p">MESSAGES</Typography>}
                />
              </ListItem>
              <ListItem button key={8}>
                ...
                <ListItemText
                  xs={8}
                  primary={<Typography variant="p">LOGOUT</Typography>}
                />
              </ListItem>
            </List>
          </Grid>
